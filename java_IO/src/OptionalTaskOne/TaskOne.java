...
public class TaskOne {
    ...
    public static void main(String[] args) {
        ...
        File inputFile = new File(System.getProperty("user.dir") + "\\java_IO\\src\\OptionalTask\\numbers.txt");
        File outputFile = new File(System.getProperty("user.dir") + "\\java_IO\\src\\OptionalTask\\sorted_numbers.txt");
