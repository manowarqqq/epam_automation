...
import java_exceptions.exceptions.IllegalMarkArgumentEsception;
...
import java_exceptions.enumerations.Sex;
...
public class Student {
    ...
    public Double getAverageMark() throws StudentDoesntHaveLesson {
        return getMarks().values().stream().mapToInt(x -> x).average().orElse(-1);
    }
